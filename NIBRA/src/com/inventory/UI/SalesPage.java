...
public class SalesPage extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        addCustButton.setText("Clique aqui para adcionar um novo cliente");
            ...
            .addGroup(sellPanelLayout.createSequentialGroup()
                ...
                .addGroup(sellPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(sellPanelLayout.createSequentialGroup()
                        ...
                        .addComponent(prodCodeText, javax.swing.GroupLayout.PREFERRED_SIZE, 161, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(sellPanelLayout.createSequentialGroup()
    ...
    private void sellButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sellButtonActionPerformed
        if (custCodeText.getText().equals("") || prodCodeText.getText().equals("")
            ...
            JOptionPane.showMessageDialog(this, "Porfavor insira todos os dados necessarios.");
        else {
            try {
                ...
                if (resultSet.next()) {
                    ...
                    JOptionPane.showMessageDialog(this, "Cliente inexistente.\n" +
                            "Adcione um novo cliente ou use um codigo do cliente valido.");
    ...
    private void custCodeTextKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_custCodeTextKeyReleased
        try {
            ...
            custNameLabel.setText("||   Cliente inexistente na base de dados.   ||");

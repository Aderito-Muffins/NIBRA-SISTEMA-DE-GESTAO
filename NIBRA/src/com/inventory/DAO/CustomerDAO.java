...
public class CustomerDAO {
    ...
    public void addFunction(CustomerDTO customerDTO) {
        try {
            ...
            JOptionPane.showMessageDialog(null, "Um novo cliente foi adcionado.");
        } catch (SQLException e) {
            e.printStackTrace();
        }
    ...
    public  void editCustomerDAO(CustomerDTO customerDTO) {
        try {
            ...
            prepStatement.executeUpdate();
            JOptionPane.showMessageDialog(null, "Os detalhes do cliente foram actualizados!.");
        } catch (SQLException e) {
            e.printStackTrace();
        }
    }
    ...
    public ResultSet getProdName(String prodCode) {
        try {
            String query = "SELECT productname,currentstock.quantity FROM products " +
                    ...
                    "WHERE currentstock.prodType='Ovo' AND currentstock.productcode='" +prodCode+ "'";
            resultSet = statement.executeQuery(query);
        } catch (SQLException e) {
            e.printStackTrace();
        }

...
public class SupplierDAO {
    ...
    public void addSupplierDAO(SupplierDTO supplierDTO) {
        try {
            ...
            if (resultSet.next())
                JOptionPane.showMessageDialog(null, "Fornecedor ja existente!");
            else
    ...
    public void addFunction(SupplierDTO supplierDTO) {
        try {
            ...
            JOptionPane.showMessageDialog(null, "Novo fornecedor adcionado com sucesso.");
        } catch (SQLException e) {
            e.printStackTrace();
        }
    }
    ...
    public void editSupplierDAO(SupplierDTO supplierDTO) {
        try {
            ...
            prepStatement.executeUpdate();
            JOptionPane.showMessageDialog(null, "Detalhes do fornecedor actualizados com sucesso.");
        } catch (SQLException e) {
            e.printStackTrace();
        }
    }

...
public class PurchasePage extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Preco de Compra:");

        jLabel8.setText("Preco de Venda:");
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        if (purchaseTable.getSelectedRow()<0)
            JOptionPane.showMessageDialog(null,  "Porfavor selecione uma transacao na Tabela.");
        else {
            int opt = JOptionPane.showConfirmDialog(
                    null,
                    "Tem certeza que deseja eliminar esta transacao?",
                    "Confirmacao",
